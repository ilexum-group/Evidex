...
import "github.com/ilexum-group/evidex/pkg/models"
...
type MetadataExtractor interface {
	...
	Extract(filePath string) (interface{}, error)
...
// ExtractMetadata uses the registry to extract metadata polymorphically
func (r *ExtractorRegistry) ExtractMetadata(filePath string) (interface{}, error) {
	extractor := r.FindExtractor(filePath)
	if extractor == nil {
		return nil, nil
	}
